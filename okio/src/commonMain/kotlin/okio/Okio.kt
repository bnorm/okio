 ...
 */
fun Source.buffer(): BufferedSource = this as? RealBufferedSource ?: RealBufferedSource(this)
 ...
 */
fun Sink.buffer(): BufferedSink = this as? BufferedSink ?: RealBufferedSink(this)
